...
<body class="hold-transition skin-blue sidebar-mini" onload="selectAutoRadio('<?= $_SESSION['admin'][0]->genero?>','genero'), selectAutoOption('<?= $_SESSION['admin'][0]->cargo?>','cargo'), selectAutoOption('<?= $_SESSION['admin'][0]->pais?>','pais') ">
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-success">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="admin.controller.php?acao=editar" method='post' name="form_cad">
              <div class="box-body">
                <div class="form-group">
                  <label>Nome</label>
                  <input type="text" class="form-control"  placeholder="Digite o nome do usuário" value="<?=$_SESSION['admin'][0]->nome?>" name="name">
                </div>
                <div class="form-group">
                  <label>Gênero</label>
                  <div class="radio">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" value="<?=$_SESSION['admin'][0]->data_nascimento?>"  name="data_nascimento">
                </div>
                <div class="form-group">
                  <label>Cargo</label>
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="exampleInputEmail1" value="<?=$_SESSION['admin'][0]->email?>" placeholder="Digite o e-mail" name="email">
                </div>
                <input type="hidden" name="id"  value="<?=$_SESSION['admin'][0]->id?>">
                <div class="checkbox">
                  <label>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-success" onclick="ValidaForm()">Salvar</button>
              </div>
            </form>
          </div>
