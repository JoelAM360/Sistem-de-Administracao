...
<body class="hold-transition skin-blue sidebar-mini" onload="selectAutoRadio('<?= $_SESSION['aluno'][0]->genero?>','genero'), selectAutoOption('<?= $_SESSION['aluno'][0]->pais?>','pais'), selectAutoOption('<?= $_SESSION['aluno'][0]->provincia?>','provincia') ">
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
       ...
       <ul class="navbar navbar-expand-lg sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="index.php"><i class="fa fa-user" aria-hidden="true"></i> <span>Admin</span></a></li>
    ...
    <section class="content container-fluid">
      ...
      <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action='aluno.controller.php?acao=editar' method='post' name="form_cad" id="form-user-create">
              <div class="box-body">
                <fieldset>
                  ...
                  <div class="row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="nome" value="<?=$_SESSION['aluno'][0]->nome_aluno?>"  class="form-control">
                    </div>
                    <div class="form-group col-md-6">
                      <label>Data Nascimento</label><span style="color: red;">*</span>
                      <input type="date"  name="data_nascimento" value="<?=$_SESSION['aluno'][0]->data_nascimento?>"  class="form-control">
                    </div>
                    <div class="form-group col-md-6" >
                      <label>Gênero</label><span style="color: red;">*</span><br>
                       <input type="radio" value="masculino"  name="genero"> <strong>Masculino</strong>
                       <input type="radio" value="femenino" name="genero"> <strong>Femenino</strong>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="endereco" value="<?=$_SESSION['aluno'][0]->endereco?>" class="form-control" placeholder="ex. Nome da Rua, 56 Bloco 2, Ap 301">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="phone1"  value="<?=$_SESSION['aluno'][0]->telefone?>"  placeholder="ex. 923456949"  class="form-control" >
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="email" name="email" value="<?=$_SESSION['aluno'][0]->email?>" placeholder="ex. aluno@exemplo.com"  class="form-control">
                    </div>
                    <div class="form-group col-md-6">
                      <input type="hidden" name="id" value="<?=$_SESSION['aluno'][0]->id_aluno?>" class="form-control">
                    </div>
                  </div>
