  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
     ...
     <ul class="navbar navbar-expand-lg sidebar-menu" data-widget="tree">
      ...
      <li class="active"><a href="lista_curso.php"><i class="fa fa-list" aria-hidden="true"></i> <span>Cursos Disponíveis</span></a></li>
          ...
          <div class="box">
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tbody>
                <?php foreach ($service_curso as $value) {?>
                  <tr>
                    <td><img src="dist/img/cursos/<?= $value->img_curso ?>" alt="User Image" class="img-circle img-sm"></td>
                    <td><?= $value->nome_curso ?></td>
                    <td><?= $value->data_inic ?></td>
                    ...
                    <td>
                      <a href="admin.controller.php?id=<?= $value->id_curso?>&rotas=curso&acao=editar_curso" class="btn btn-primary btn-xs btn-flat">Editar</a>
                      <button type="button"  class="btn btn-danger btn-xs btn-flat" id="teste" onclick="pegar(<?=$value->id_curso?>,'<?=$value->nome_curso?>')" data-toggle="modal" data-target="#myModal_<?=$value->id_curso?>">Excluir</button>
                         <!-- The Modal -->
                         <div class="modal" id="myModal_<?=$value->id_curso?>">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  Deseja realmente excluir o/a admin <b><span id="nome_admin"><?= $value->nome_curso ?></span>?</b>
                                </div>

                                <!-- Modal footer -->
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-danger" data-dismiss="modal">Não</button>
                                  <a href="admin.controller.php?acao=remover_curso&id=<?=$value->id_curso?>"  class="btn btn-success">Sim</a>
                                </div>
