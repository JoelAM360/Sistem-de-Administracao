    ...
    <section class="content container-fluid">
      ...
      <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action='admin.controller.php?acao=cad_curso' enctype="multipart/form-data" method='post' name="form_cad">
              <div class="box-body">
                <fieldset>
                  <legend>Cadastrar Cursos</legend>
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="date"  name="data_inic" class="form-control">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" name="vagas" class="form-control" placeholder="ex. Nome da Rua, 56 Bloco 2, Ap 301">
                    </div>
                    <div class="form-group col-md-6">
                      <label>Preço</label><span style="color: red;">*</span>
                      <input type="number" name="preco" placeholder="50.000,00 Kz"  class="form-control" >
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-7">
                      ...
                      <textarea name="descricao" rows="7" placeholder="Descreva as informações relevantes sobre o curso..." class="form-control"></textarea>
                    </div>
                  </div>
