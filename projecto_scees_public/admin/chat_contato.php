  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
     ...
     <ul class="navbar navbar-expand-lg sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="cad_aluno.php"><i class="fa fa-users"></i><span>Cadastrar Alunos</span></a></li>
      <li class="active"><a href="resultado.php"><i class="fa fa-balance-scale" aria-hidden="true"></i> <span>Resultados</span></a></li>
    ...
    <section class="content container-fluid">	  
      <div class="row">
        <div class="col-md-9">
		  ...
		  <div class="ps-container ps-theme-default ps-active-y" id="chat-content" style="overflow-y: scroll !important; height:440px !important;">
	         <?php foreach ($msg as $value) { ?>
		 	 <!-- Inicio: Msg pelo User-->
		    ...
		    <!-- Inicio: Caixa de Escrever a Mensagem-->
            ...
            <!-- Fim: Caixa de Escrever a Mensagem-->
        </div>
